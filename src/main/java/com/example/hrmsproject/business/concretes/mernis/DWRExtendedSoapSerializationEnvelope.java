...
public class DWRExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DWRDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DWRStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DWRDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DWRDateTimeConverter dateTimeConverter = new DWRStandardDateTimeConverter();

    public DWRExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DWRExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DWRMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DWRHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DWRExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DWRHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
