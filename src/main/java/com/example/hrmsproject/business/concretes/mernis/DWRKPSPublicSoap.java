...
public class DWRKPSPublicSoap
{
    ...
    public DWRKPSPublicSoap(){}

    public DWRKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DWRKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DWRExtendedSoapSerializationEnvelope envelope= new DWRExtendedSoapSerializationEnvelope(DWRExtendedSoapSerializationEnvelope.VER11);
